...
export function platformParameterDefinitions(): PlatformParameterDefinition[] {
  ...
  return [
    {
      key: "SPEED_TO_LEAD_SLA_SECONDS",
      label: "SLA de primeira resposta",
      category: "Speed to Lead",
      value: speed.slaSeconds,
      defaultValue: 300,
      description: "Tempo alvo em segundos para a primeira resposta ao lead.",
    },
    {
      key: "SPEED_TO_LEAD_METRICS_DAYS",
      label: "Janela de métricas",
      category: "Speed to Lead",
      value: speed.metricsDays,
      defaultValue: 7,
      description: "Quantidade de dias exibidos nas métricas operacionais.",
    },
    {
      key: "SPEED_TO_LEAD_HISTORY_DAYS",
      label: "Janela histórica",
      category: "Speed to Lead",
      value: speed.historyDays,
      defaultValue: 30,
      description: "Período máximo consultado para histórico de leads e mensagens.",
    },
    {
      key: "LEAD_DISTRIBUTION_LOOKBACK_HOURS",
      label: "Janela da roleta",
      category: "Speed to Lead",
      value: speed.distributionLookbackHours,
      defaultValue: 24,
      description: "Horas consideradas para balancear a carga da roleta.",
    },
    {
      key: "OPENAI_MODEL",
      label: "Modelo de IA",
      ...
      description: "Modelo usado nas respostas e sugestões do agente.",
    },
    {
      ...
      defaultValue: 30000,
      description: "Tempo máximo de espera por uma resposta da OpenAI.",
    },
    {
      key: "AI_HISTORY_MESSAGES",
      label: "Memória curta da conversa",
      category: "Inteligência artificial",
    ...
    },
    {
      ...
      label: "Anexo máximo WhatsApp",
      category: "WhatsApp",
      value: whatsapp.maxAttachmentMb,
      defaultValue: 8,
      description: "Limite em MB para anexos enviados no Atendimento.",
    },
    {
      key: "EVOLUTION_REQUEST_TIMEOUT_MS",
      label: "Timeout Evolution",
      category: "WhatsApp",
    ...
    },
    {
      ...
      label: "Documento máximo CCA",
      category: "Documentos / CCA",
      value: docs.ccaDocumentMaxMb,
      defaultValue: 12,
      description: "Tamanho máximo de cada documento do dossiê.",
    },
    {
      key: "CCA_SIGNED_URL_TTL_SECONDS",
      label: "Validade de link CCA",
      category: "Documentos / CCA",
      value: docs.ccaSignedUrlTtlSeconds,
      defaultValue: 900,
      description: "Validade do link temporário usado no envio do dossiê.",
    },
    {
      key: "CCA_EMAIL_ATTACHMENT_MAX_MB",
      label: "Dossiê máximo por e-mail",
      category: "Documentos / CCA",
      value: docs.emailAttachmentMaxMb,
      defaultValue: 25,
      description: "Limite total de anexos por envio de e-mail ao CCA.",
    },
    {
      key: "CCA_REQUEST_TIMEOUT_MS",
      label: "Timeout conector CCA",
      category: "Documentos / CCA",
      value: docs.ccaRequestTimeoutMs,
      defaultValue: 30000,
      description: "Tempo máximo de resposta do conector contratado do CCA.",
    },
    {
      key: "EMAIL_REQUEST_TIMEOUT_MS",
      label: "Timeout de e-mail",
      category: "Integrações",
      value: docs.emailRequestTimeoutMs,
      defaultValue: 45000,
      description: "Tempo máximo para envio do e-mail com documentação.",
    },
    {
      key: "STRIPE_REQUEST_TIMEOUT_MS",
      label: "Timeout Stripe",
      category: "Integrações",
      value: services.stripeTimeoutMs,
      defaultValue: 20000,
      description: "Tempo máximo das operações de cobrança.",
    },
    {
      key: "META_REQUEST_TIMEOUT_MS",
      label: "Timeout Meta",
      category: "Integrações",
      value: services.metaTimeoutMs,
      defaultValue: 25000,
      description: "Tempo máximo das chamadas Facebook/Instagram.",
    },
    {
      key: "TWILIO_REQUEST_TIMEOUT_MS",
      label: "Timeout telefonia",
      category: "Integrações",
      value: services.twilioTimeoutMs,
      defaultValue: 25000,
      description: "Tempo máximo das chamadas à API de telefonia.",
    },
    {
      key: "VOICE_BRIDGE_TOKEN_MINUTES",
      label: "Validade do token do discador",
      category: "Integrações",
      value: services.voiceBridgeTokenMinutes,
      defaultValue: 5,
      description: "Validade em minutos do token temporário usado para ligar corretor e cliente.",
    },
  ];
}
...
export function integrationReadiness() {
  return [
    ...
    },
    {
      ...
      configured: Boolean(process.env["GOOGLE_MAPS_API_KEY"]?.trim()),
    },
    {
      key: "email",
      label: "E-mail / SMTP",
      configured: Boolean(
        ((process.env["SMTP_PASSWORD"]?.trim() || process.env["SMTP_PASS"]?.trim()) &&
          (process.env["SMTP_USER"]?.trim() || process.env["EMAIL_FROM"]?.trim())) ||
    ...
    },
    {
      key: "cca",
      label: "Conector CCA",
      configured: Boolean(process.env["CCA_INTEGRATION_URL"]?.trim()),
    },
    {
      key: "lead-webhook",
