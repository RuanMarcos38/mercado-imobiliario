    ...
    <div className="min-h-screen bg-[#07111f] text-white">
      <header className="border-b border-white/10 bg-[#07111f]/90 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-5xl items-center justify-between px-4 sm:px-6">
          ...
          <Link
            to="/dashboard"
            className="inline-flex items-center gap-2 rounded-xl border border-white/10 px-3 py-2 text-sm text-slate-300 hover:bg-white/5"
          >
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 sm:px-6 lg:py-14">
        ...
        <div className="space-y-5">
          <Card className="rounded-3xl border-white/10 bg-white/[0.04] text-white">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <UserRound className="h-5 w-5 text-cyan-300" /> Seus dados
              </CardTitle>
            ...
            <CardContent className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-2xl border border-white/10 bg-black/10 p-4">
                <span className="flex items-center gap-1.5 text-xs font-semibold uppercase tracking-[0.14em] text-slate-500">
          ...
          <Card className="rounded-3xl border-white/10 bg-white/[0.04] text-white">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                <KeyRound className="h-5 w-5 text-cyan-300" /> Alterar senha
              </CardTitle>
              <CardDescription className="text-slate-400">
            ...
            <CardContent className="space-y-4">
              ...
              <Button
                ...
                className="bg-cyan-300 font-bold text-[#06101c] hover:bg-cyan-200"
              >
